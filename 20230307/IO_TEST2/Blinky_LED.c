...
#define LED2        &MODULE_P00,7                                           /* LED: Port, Pin definition            */
#define LED3         &MODULE_P00,3                                           /* LED: Port, Pin definition            */
...
{
    cy++;
    if(cy%5 ==0){IfxPort_togglePin(LED1);}                                                     /* Toggle the state of the LED      */
    if(cy%10 ==0){IfxPort_togglePin(LED2);}                                                     /* Toggle the state of the LED      */
    if(cy%20 ==0){IfxPort_togglePin(LED3);}                                                     /* Toggle the state of the LED      */
